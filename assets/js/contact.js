...
// 方案 F「轻奢线框」：SVG 描边样式在 CSS 中通过 .contact-icon svg 统一控制
// 这里只保留 viewBox / 尺寸等结构性属性
const SVG_ATTRS = 'viewBox="0 0 24 24" width="20" height="20"';

const ICON_SVGS = {
    phone: `<svg ${SVG_ATTRS}><path d="M5 4h4l2 5-2.5 1.5a11 11 0 0 0 5 5L15 13l5 2v4a2 2 0 0 1-2 2A16 16 0 0 1 3 6a2 2 0 0 1 2-2z"/></svg>`,
    mail:  `<svg ${SVG_ATTRS}><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/></svg>`,
    pin:   `<svg ${SVG_ATTRS}><path d="M12 21s-6-5.2-6-10a6 6 0 1 1 12 0c0 4.8-6 10-6 10z"/><circle cx="12" cy="11" r="2.5"/></svg>`,
    whatsapp: `<svg ${SVG_ATTRS}><path d="M7.9 20A9 9 0 1 0 4 16.1L3 21l4.9-1z"/><path d="M8.5 13.5c.6 1.1 2.1 2.6 3.2 3.2l1.2-1.2c.2-.2.5-.3.8-.2.9.3 1.9.5 2.9.5.3 0 .6.3.6.6v1.7c0 .3-.2.5-.5.6-1 .2-2 .1-2.9-.2-.3-.1-.6 0-.8.2"/></svg>`
};
